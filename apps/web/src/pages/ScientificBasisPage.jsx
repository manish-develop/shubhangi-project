...
const ScientificBasisPage = () => {
  ...
  return (
    <>
      <SEO
        title="Scientific Basis | Maharana Wellness Clinic"
        description="Read about the scientific basis of homoeopathy at Maharana Wellness Clinic by Dr. Shubhangi Maharana."
        path="/scientific-basis"
      />
